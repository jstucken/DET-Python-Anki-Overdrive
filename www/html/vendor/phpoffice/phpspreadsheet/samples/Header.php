...
<head>
    ...
    <link rel="stylesheet" href="/vendor/phpoffice/phpspreadsheet/samples/bootstrap/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="/vendor/phpoffice/phpspreadsheet/samples/bootstrap/css/font-awesome.min.css"/>
    <link rel="stylesheet" href="/vendor/phpoffice/phpspreadsheet/samples/bootstrap/css/phpspreadsheet.css"/>
    <script src="/vendor/phpoffice/phpspreadsheet/samples/bootstrap/js/jquery.min.js"></script>
    <script src="/vendor/phpoffice/phpspreadsheet/samples/bootstrap/js/bootstrap.min.js"></script>
</head>
<body>
    <div class="container">
                    ...
                    foreach ($helper->getSamples() as $category => $files) {
                        ?><li class="dropdown">
                            ...
                            foreach ($files as $name => $file) {
                                echo '<li><a href="/vendor/phpoffice/phpspreadsheet/samples/' . $file . '">' . $name . '</a></li>';
                            } ?></ul>
                        </li>
                    <?php
                    } ?>
